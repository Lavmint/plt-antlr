...
// $ANTLR 3.5.2 ArtGrammar.g 2015-12-05 01:41:47
...
public partial class ArtGrammarLexer : Antlr.Runtime.Lexer
{
	...
	public ArtGrammarLexer()
	{
		OnCreated();
	}

	public ArtGrammarLexer(ICharStream input )
		: this(input, new RecognizerSharedState())
	{
	}

	public ArtGrammarLexer(ICharStream input, RecognizerSharedState state)
		: base(input, state)
	{
	...
	private void mAND()
	{
		...
		try
		{
			...
			// ArtGrammar.g:7:5: ( 'and' )
			DebugEnterAlt(1);
			// ArtGrammar.g:7:7: 'and'
			{
			DebugLocation(7, 7);
			Match("and"); 
	...
	private void mASSIGN()
	{
		...
		try
		{
			int _type = ASSIGN;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:8:8: ( 'ass' )
			DebugEnterAlt(1);
			// ArtGrammar.g:8:10: 'ass'
			{
			DebugLocation(8, 10);
			Match("ass"); 
	...
	private void mBEGIN()
	{
		...
		try
		{
			int _type = BEGIN;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:9:7: ( 'begin' )
			DebugEnterAlt(1);
			// ArtGrammar.g:9:9: 'begin'
			{
			DebugLocation(9, 9);
			Match("begin"); 
	...
	private void mDO()
	{
		...
		try
		{
			int _type = DO;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:13:4: ( 'do' )
			DebugEnterAlt(1);
			// ArtGrammar.g:13:6: 'do'
			{
			DebugLocation(13, 6);
			Match("do"); 
	...
	private void mELSE()
	{
		...
		try
		{
			int _type = ELSE;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:15:6: ( 'else' )
			DebugEnterAlt(1);
			// ArtGrammar.g:15:8: 'else'
			{
			DebugLocation(15, 8);
			Match("else"); 
	...
	private void mEND()
	{
		...
		try
		{
			int _type = END;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:16:5: ( 'end' )
			DebugEnterAlt(1);
			// ArtGrammar.g:16:7: 'end'
			{
			DebugLocation(16, 7);
			Match("end"); 
	...
	private void mFALSE()
	{
		...
		try
		{
			int _type = FALSE;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:18:7: ( 'false' )
			DebugEnterAlt(1);
			// ArtGrammar.g:18:9: 'false'
			{
			DebugLocation(18, 9);
			Match("false"); 
	...
	private void mFOR()
	{
		...
		try
		{
			int _type = FOR;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:19:5: ( 'for' )
			DebugEnterAlt(1);
			// ArtGrammar.g:19:7: 'for'
			{
			DebugLocation(19, 7);
			Match("for"); 
	...
	private void mIF()
	{
		...
		try
		{
			int _type = IF;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:22:4: ( 'if' )
			DebugEnterAlt(1);
			// ArtGrammar.g:22:6: 'if'
			{
			DebugLocation(22, 6);
			Match("if"); 
	...
	private void mNOT()
	{
		...
		try
		{
			int _type = NOT;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:29:5: ( 'not' )
			DebugEnterAlt(1);
			// ArtGrammar.g:29:7: 'not'
			{
			DebugLocation(29, 7);
			Match("not"); 
	...
	private void mOR()
	{
		...
		try
		{
			int _type = OR;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:31:4: ( 'or' )
			DebugEnterAlt(1);
			// ArtGrammar.g:31:6: 'or'
			{
			DebugLocation(31, 6);
			Match("or"); 
	...
	private void mPROGRAM()
	{
		...
		try
		{
			int _type = PROGRAM;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:33:9: ( 'program' )
			DebugEnterAlt(1);
			// ArtGrammar.g:33:11: 'program'
			{
			DebugLocation(33, 11);
			Match("program"); 
	...
	private void mREAD()
	{
		...
		try
		{
			int _type = READ;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:35:6: ( 'read' )
			DebugEnterAlt(1);
			// ArtGrammar.g:35:8: 'read'
			{
			DebugLocation(35, 8);
			Match("read"); 
	...
	private void mTHEN()
	{
		...
		try
		{
			int _type = THEN;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:41:6: ( 'then' )
			DebugEnterAlt(1);
			// ArtGrammar.g:41:8: 'then'
			{
			DebugLocation(41, 8);
			Match("then"); 
	...
	private void mTO()
	{
		...
		try
		{
			int _type = TO;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:42:4: ( 'to' )
			DebugEnterAlt(1);
			// ArtGrammar.g:42:6: 'to'
			{
			DebugLocation(42, 6);
			Match("to"); 
	...
	private void mTRUE()
	{
		...
		try
		{
			int _type = TRUE;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:43:6: ( 'true' )
			DebugEnterAlt(1);
			// ArtGrammar.g:43:8: 'true'
			{
			DebugLocation(43, 8);
			Match("true"); 
	...
	private void mVAR()
	{
		...
		try
		{
			int _type = VAR;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:44:5: ( 'var' )
			DebugEnterAlt(1);
			// ArtGrammar.g:44:7: 'var'
			{
			DebugLocation(44, 7);
			Match("var"); 
	...
	private void mWHILE()
	{
		...
		try
		{
			int _type = WHILE;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:45:7: ( 'while' )
			DebugEnterAlt(1);
			// ArtGrammar.g:45:9: 'while'
			{
			DebugLocation(45, 9);
			Match("while"); 
	...
	private void mWRITE()
	{
		...
		try
		{
			int _type = WRITE;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:46:7: ( 'write' )
			DebugEnterAlt(1);
			// ArtGrammar.g:46:9: 'write'
			{
			DebugLocation(46, 9);
			Match("write"); 
	...
	private void mCOMMENT()
	{
		...
		try
		{
			int _type = COMMENT;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:59:9: ( LCURLY ( . )* RCURLY )
			DebugEnterAlt(1);
			// ArtGrammar.g:59:11: LCURLY ( . )* RCURLY
			{
			DebugLocation(59, 11);
			mLCURLY(); 
			DebugLocation(59, 17);
	...
	private void mIDENT()
	{
		...
		try
		{
			int _type = IDENT;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:62:7: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )* )
			DebugEnterAlt(1);
			// ArtGrammar.g:62:9: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )*
			{
			DebugLocation(62, 9);
			...
			DebugLocation(62, 29);
			// ArtGrammar.g:62:29: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )*
			...
			while (true)
			{
				...
				if (((LA4_1>='0' && LA4_1<='9')||(LA4_1>='A' && LA4_1<='Z')||(LA4_1>='a' && LA4_1<='z')))
				{
					alt4 = 1;
				}
	...
	private void mNUM_BIN()
	{
		...
		try
		{
			int _type = NUM_BIN;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:64:9: ( ( '0' .. '1' )+ ( 'B' | 'b' ) )
			DebugEnterAlt(1);
			// ArtGrammar.g:64:11: ( '0' .. '1' )+ ( 'B' | 'b' )
			{
			DebugLocation(64, 11);
			// ArtGrammar.g:64:11: ( '0' .. '1' )+
			int cnt5=0;
	...
	private void mNUM_OCT()
	{
		...
		try
		{
			int _type = NUM_OCT;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:65:9: ( ( '0' .. '7' )+ ( 'O' | 'o' ) )
			DebugEnterAlt(1);
			// ArtGrammar.g:65:11: ( '0' .. '7' )+ ( 'O' | 'o' )
			{
			DebugLocation(65, 11);
			// ArtGrammar.g:65:11: ( '0' .. '7' )+
			int cnt6=0;
	...
	private void mNUM_DEC()
	{
		...
		try
		{
			int _type = NUM_DEC;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:66:9: ( ( '0' .. '9' )+ ( 'D' | 'd' )? )
			DebugEnterAlt(1);
			// ArtGrammar.g:66:11: ( '0' .. '9' )+ ( 'D' | 'd' )?
			{
			DebugLocation(66, 11);
			// ArtGrammar.g:66:11: ( '0' .. '9' )+
			int cnt7=0;
	...
	private void mNUM_HEX()
	{
		...
		try
		{
			int _type = NUM_HEX;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:67:9: ( ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )+ ( 'H' | 'h' ) )
			DebugEnterAlt(1);
			// ArtGrammar.g:67:11: ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )+ ( 'H' | 'h' )
			{
			DebugLocation(67, 11);
			// ArtGrammar.g:67:11: ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )+
			int cnt9=0;
	...
	private void mNUM_REAL()
	{
		...
		try
		{
			int _type = NUM_REAL;
			int _channel = DefaultTokenChannel;
			// ArtGrammar.g:69:9: ( ( '0' .. '9' )+ EXPONENT | ( '0' .. '9' )? DOT ( '0' .. '9' )+ ( EXPONENT )? )
			int alt14=2;
			...
			if (((LA14_1>='0' && LA14_1<='9')))
			{
				...
				if (((LA14_2>='0' && LA14_2<='9')||LA14_2=='E'||LA14_2=='e'))
				{
					alt14 = 1;
				}
				else if ((LA14_2=='.'))
			...
			case 1:
				DebugEnterAlt(1);
				// ArtGrammar.g:69:11: ( '0' .. '9' )+ EXPONENT
				{
				DebugLocation(69, 11);
				// ArtGrammar.g:69:11: ( '0' .. '9' )+
				int cnt10=0;
			...
			case 2:
				DebugEnterAlt(2);
				// ArtGrammar.g:69:31: ( '0' .. '9' )? DOT ( '0' .. '9' )+ ( EXPONENT )?
				{
				DebugLocation(69, 31);
				// ArtGrammar.g:69:31: ( '0' .. '9' )?
				int alt11=2;
	...
	private void mEXPONENT()
	{
		...
		try
		{
			// ArtGrammar.g:70:18: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
			DebugEnterAlt(1);
			// ArtGrammar.g:70:21: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
			{
			DebugLocation(70, 21);
	...
	{
		// ArtGrammar.g:1:8: ( AND | ASSIGN | BEGIN | BOOLEAN | COLON | COMMA | DO | DOT | ELSE | END | EQUAL | FALSE | FOR | GE | GT | IF | INTEGER | LCURLY | LE | LPAREN | LT | MINUS | NOT | NOT_EQUAL | OR | PLUS | PROGRAM | RCURLY | READ | REAL | RPAREN | SEMI | SLASH | STAR | THEN | TO | TRUE | VAR | WHILE | WRITE | WS | COMMENT | IDENT | NUM_BIN | NUM_OCT | NUM_DEC | NUM_HEX | NUM_REAL )
		int alt17=48;
